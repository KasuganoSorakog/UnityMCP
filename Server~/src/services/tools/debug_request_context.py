...
async def debug_request_context(ctx: Context) -> dict[str, Any]:
    ...
    request_identity = extract_request_identity(ctx)
    ...
    scheduler_snapshot = await PluginHub.get_scheduler_snapshot() if plugin_hub_configured else {}
    ...
    return {
        ...
        "data": {
            ...
            "session_state": {
                ...
                "derived_key_inputs": request_identity,
