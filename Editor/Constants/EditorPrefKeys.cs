namespace MCPForUnity.Editor.Constants
{
    ...
    internal static class EditorPrefKeys
    {
        ...
        internal const string ManualReconnectRequired = "MCPForUnity.ManualReconnectRequired";
        // 按工程 hash 拼接（SupersededPrefix + projectHash），标记本工程 Session 已被同工程另一实例顶替，项目级隔离
        internal const string SupersededPrefix = "MCPForUnity.Superseded.";
