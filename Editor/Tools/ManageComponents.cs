    ...
    public static class ManageComponents
    {
        ...
        private static object AddComponent(JObject @params, JToken targetToken, string searchMethod)
        {
            ...
            if (properties != null && properties.HasValues)
            {
                ...
                List<string> propertyErrors = SetPropertiesOnComponent(newComponent, properties);
                if (propertyErrors.Count > 0)
                {
                    ...
                    {
                        success = false,
                        message = $"Component '{componentTypeName}' was added to '{targetGo.name}', but some properties failed to set.",
                        data = new
                        {
        ...
        private static List<string> SetPropertiesOnComponent(Component component, JObject properties)
        {
            ...
            {
                errors.Add("Invalid component or properties object.");
                return errors;
            }
